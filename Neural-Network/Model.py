...
def feature_matrix(distance_matrix, embedding_matrix, hyperparameters):
    g1 = embedding_matrix
    g2 = Lambda(lambda x: x[:, :, :hyperparameters.M2])(embedding_matrix)
...
def res_embedding_model(matrix, features, n_max, hyperparameters):
    ...
    r = Dense(n_max * hyperparameters.M1, activation=ModelConstants.activation)(r)
    r = Reshape((n_max, hyperparameters.M1))(r)
...
def get_model(hyperparameters):
    ...
    # feature matrix
    local_feature_matrix = feature_matrix(input_local_matrix, local_embedding_layer, hyperparameters)
    ...
    reduced_feature_matrix = Dense(hyperparameters.M2, activation=ModelConstants.activation)(concatenated_feature_matrix)
